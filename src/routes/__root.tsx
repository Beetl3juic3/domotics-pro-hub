...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Smarthome SPNOS · Gestão de Obras" },
      { name: "description", content: "Smarthome SPNOS - App para técnicos gerirem obras e checklists." },
      { property: "og:title", content: "Smarthome SPNOS · Gestão de Obras" },
      { property: "og:description", content: "Smarthome SPNOS - App para técnicos gerirem obras e checklists." },
